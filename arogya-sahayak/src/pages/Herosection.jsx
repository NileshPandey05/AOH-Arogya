...
const Home = () => {
  return (
    <div className="bg-white">
      ...
      {/* Contact Information */}
      <section className="flex flex-col items-center justify-center w-[95%]  py-8 md:px-10 md:py-16 md:border rounded-md  h-[180px] md:ml-[28px] md:mt-[-63px] mt-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl space-x-9 mx-auto md:ml-4">
          <div className=" flex flex-col mt-20 ml-8 md:ml-0 ">
